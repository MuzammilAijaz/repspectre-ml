...
def split_data(data, train_ratio, valid_ratio):  # pylint: disable=redefined-outer-name
  ...
  # count the number of examples for each gesture inside num_dic
  ...
  train_num_dic = {} # holds, for each gesture, the no. of examples for training
  valid_num_dic = {}

  # train/validation split per gesture
  for i in num_dic:
  ...
  # for each gesture, append the example to either : training or validation else test
