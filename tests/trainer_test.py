...
class TestTrain(unittest.TestCase):
    def setUp(self) -> None:
        ...
        self.config = Config(
            ...
            model=ModelConfig(type="cnn", epochs=1, batch_size=2),
    ...
    def test_get_model_factory_returns_valid_cnn_model(self) -> None:
        model = get_model(self.config)
        self.assertIsInstance(model, tf.keras.Model)
        # Check input shape for CNN
        self.assertEqual(model.input_shape, (None, 5, 2, 1))

    def test_trainer_train_smoke_runs_full_pipeline_without_crash(self) -> None:
    ...
    def test_reshape_function_applies_cnn_transformation_correctly(self) -> None:
        trainer = Trainer(self.config)
    ...
    def test_load_data_augmentation_toggle_increases_sample_count(self) -> None:
        trainer = Trainer(self.config)
    ...
    def test_reshape_function_for_lstm_keeps_data_2d(self) -> None:
    ...
    def test_trainer_train_generates_tensorboard_logs(self) -> None:
    ...
    def test_export_model_creates_missing_directory(self) -> None:
