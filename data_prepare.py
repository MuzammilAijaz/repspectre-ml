...
def generate_negative_data(data):  # pylint: disable=redefined-outer-name
  ...
  3 different types of negative data is generated :
    Straightish line : simulates walking, running etc.
    Random : simulates complete noise
    Still : simulates being idle (ex. on table)
  """

  # ------------------ Different type of Data ------------------
  # general note : .random() - 0.5 is done to also generate negative values
...
if __name__ == "__main__":
  ...
  # for all folders generate output
